...
import RecipeList from "./RecipeList"; // RecipeList 컴포넌트 확인
import * as ImagePicker from "expo-image-picker"; // 이미지 추가를 위한 라이브러리
      ...
      <View style={styles.boardSection}>
        ...
        <View style={styles.boardHeader}>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate("MyRecipePost")}>  
